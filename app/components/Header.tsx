    ...
    return (
        <header className="min-w-screen relative h-96 bg-red-400">
            <img
                ...
                alt=""
            />
            <div className="w-3/4 sm:w-full flex flex-col items-center absolute -bottom-20 right-1/2 translate-x-1/2 translate-y-40">
                ...
                <p className="font-light mt-2 text-center">Hello! I am a Full stack software engineer focused on front-end with 3+ years of experience in building for the web.<br /> Outside of work I love adventure sports, travelling and trying the new sushi place in town.<br /> Why this page you ask? because Instagram wasn't enough 😂</p>
            </div>
        </header>
    )
}
